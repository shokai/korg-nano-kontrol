(function() {
  var Device, NanoKONTROL, Util, debug,
  ...
  module.exports = NanoKONTROL = (function(superClass) {
    ...
    NanoKONTROL.deviceName = 'nanoKONTROL';

    NanoKONTROL.detect = function(name) {
      return /^nanoKONTROL/i.test(name);
    };

    function NanoKONTROL(input, name1) {
      this.input = input;
      this.name = name1;
